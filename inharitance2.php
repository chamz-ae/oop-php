...
class Comic extends Product {
    public function getInfoProduct() {
        $str = "Comic : {$this->title} | {$this->getLabel()} (Rp. {$this->price
        }) - {$this->page} Page.";
...
class game extends Product {
    public function getInfoProduct() {
        $str = "Game : {$this->title} | {$this->getLabel()} (Rp. {$this->price
        }) - {$this->hours} Hours.";
...
$product1 = new Comic("Naruto", "Kakashi", "Kagura", 1999, 100, null);
$product2 = new Game("Tereliye", "Nial Horan", "Khai", 5999, null, 50);
